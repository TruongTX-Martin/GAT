...
public @interface NotifyType {
     ...
     * 4.1.1 page_message_main : GroupMessageActivity
     */
    int MESSAGE_UNREAD  = 00;

    /**
     * “user name" Gửi tin nhắn tới bạn
     * 4.1.2 page_message_private : MessageActivity
     */
    int MESSAGE_FROM    = 01;

    /**
     * “user name" Gửi yêu cầu mượn sách “tên sách"
     * 6.4.1 request_detail : BookDetailOwnerActivity
     */
     ...
     * 6.3.1 page_user_request : BookDetailSenderActivity
     */
     ...
     * Target: 6.4.1 request_detail : BookDetailOwnerActivity
     */
