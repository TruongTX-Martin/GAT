...
/**
 * Created by mryit on 5/18/2017.
 */

public class BadgeTabLayout extends TabLayout {
    private final static String TAG = BadgeTabLayout.class.getSimpleName();
    ...
    public BadgeTabLayout playNotification (int position, int notice_count) {
        Tab mTab = getTabAt(position);
        View mView;

        mView = LayoutInflater.from(this.getContext())
                .inflate(R.layout.custom_tab_layout, this, false);
        ...
        private Builder(TabLayout parent, @NonNull TabLayout.Tab tab) {
            ...
            if (tab.getCustomView() != null) {
                ...
                this.mView = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.custom_tab_layout, parent, false);
            }
