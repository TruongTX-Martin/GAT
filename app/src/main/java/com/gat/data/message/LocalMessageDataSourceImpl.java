...
public class LocalMessageDataSourceImpl implements MessageDataSource {
    private final String TAG = LocalMessageDataSourceImpl.class.getSimpleName();
    ...
    public LocalMessageDataSourceImpl() {
